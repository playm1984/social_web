          ...
          <g>
            ...
            <g style={{ clipPath: "url(#SVGID_2_)" }}>
              <g>
                ...
                <path
                  style={{ fill: "#F1C9A5" }}
                  d="M46.685,71.474c-0.643-4.66,1.924-8.76,5.727-9.156c3.81-0.397,7.416,3.063,8.055,7.724
              ...
              <path
                style={{ fill: "#0D313D" }}
                d="M107.053,116.94c-2.726-5.158-14.082-9.191-23.065-11.656l-11.601,39.489l-11.601-39.489
              ...
              <path
                style={{ fill: "#FFFFFF" }}
                d="M57.359,121.332l9.077-8.437l5.935,5.648l-8.152-14.161l-4.979,0.383
				C58.883,110.271,57.359,121.332,57.359,121.332z"
              />
              <path
                style={{ fill: "#FFFFFF" }}
                d="M87.385,121.332l-9.077-8.437l-5.936,5.648l8.152-14.161l4.979,0.383
				C85.861,110.271,87.385,121.332,87.385,121.332z"
              />
              <path
                style={{ fill: "#262421" }}
                d="M95.443,63.508c0,0-3.744-2.825-5.348,5.467c0.521-7.792,0.142-18.541-6.181-20.508
