        ...
        <g>
          ...
          <g>
            ...
            <g style={{ clipPath: "url(#SVGID_2_)" }}>
              <path
                style={{ fill: "#471B18" }}
                d="M73.415,33.032c0,0-10.129-2.383-18.766,4.169c-8.637,6.553-4.051,15.877-12.391,23.323
              ...
              <g>
                ...
                <path
                  style={{ fill: "#E4B692" }}
                  d="M72.387,102.564c0,0,30,5.543,34.666,14.376c4.385,11.133,6.334,27.833,6.334,27.833h-41V102.564
					z"
                />
                <rect
                  x="64.219"
                ...
                <path
                  ...
                  d="M64.219,97.273c1.469,4.217,7.398,6.634,11.752,6.634
                ...
                <path
                  style={{ fill: "#F1C9A5" }}
                  d="M46.684,70.986c-0.643-4.953,1.924-9.311,5.727-9.732c3.81-0.421,7.416,3.256,8.055,8.209
					c0.643,4.949-1.93,9.309-5.734,9.732C50.924,79.613,47.323,75.939,46.684,70.986z"
                />
                <path
                  style={{ fill: "#E4B692" }}
                  d="M93.387,67.357c0-17.074-9.402-26.783-21-26.783v57.7C83.985,98.274,93.387,84.432,93.387,67.357
					z"
                />
              </g>
              <polygon
              ...
              <path
                style={{ fill: "#FE393E" }}
                d="M67.459,144.773l-4.744-40.007c-10.615,1.666-22.643,7.719-24.994,12.174
				c-3.449,12.258-6.334,27.833-6.334,27.833H67.459z"
              />
              <path
                style={{ fill: "#FE393E" }}
                d="M79.336,144.773h34.051c0,0-1.949-16.7-6.334-27.833c-3.828-6.82-18.959-10.514-24.232-12.067
				L79.336,144.773z"
              />
              <path
                style={{ fill: "#471B18" }}
                d="M72.334,49.683c0,0-4.525,9.762-10.9,12.833c-10.047,4.842-1.33,12.234-2.5,22.091
              ...
              <path
                style={{ fill: "#471B18" }}
                d="M72.334,49.683c0,0,0.506,7.666,8.219,8.333c7.715,0.667,8.715,6.318,7.215,11.409
