        ...
        <g>
          ...
          <g>
            ...
            <g style={{ clipPath: "url(#SVGID_2_)" }}>
              <path
                style={{ fill: "#F1C9A5" }}
                d="M106.971,116.94c-4.666-8.833-34.666-14.376-34.666-14.376s-30,5.543-34.666,14.376
              ...
              <path
                ...
                d="M64.138,97.273c1.469,4.217,7.397,6.634,11.751,6.634
				c1.575,0,3.107-0.264,4.583-0.747V84.606H64.138V97.273z"
              />
              <path
                style={{ fill: "#F1C9A5" }}
                d="M93.305,67.357c0-17.074-9.402-26.783-21-26.783c-11.598,0-21,9.709-21,26.783
				s9.402,30.917,21,30.917C83.903,98.274,93.305,84.432,93.305,67.357z"
              />
              <path
                style={{ fill: "#E4B692" }}
                d="M90.109,79.195c-3.807-0.424-6.377-4.783-5.732-9.732c0.637-4.953,4.242-8.63,8.051-8.209
				c3.805,0.422,6.371,4.779,5.729,9.732C97.517,75.939,93.916,79.613,90.109,79.195z"
              />
              <path
                style={{ fill: "#F1C9A5" }}
                d="M46.603,70.986c-0.643-4.953,1.924-9.311,5.726-9.732c3.811-0.421,7.416,3.256,8.055,8.209
              ...
              <path
                style={{ fill: "#0F303F" }}
                d="M62.371,90.815c0,0-9.057-7.381-7.044-17.107c2.012-9.727,7.044-11.403,7.044-15.766
              ...
              <path
                style={{ fill: "#F3641E" }}
                d="M72.304,51.159c10.84,0,19.845,7.834,21.678,18.148c0.224-1.26,0.347-2.554,0.347-3.877
              ...
              <path
                style={{ fill: "#FA582A" }}
                d="M56.287,106.577c2.938,1.574,9.807,4.855,16.017,4.855c8.168,0,18.845-4,18.845-4l-1.469-0.423
              ...
              <path
                style={{ fill: "#1594A3" }}
                d="M106.971,116.94c-1.578-2.987-6.056-5.596-11.287-7.743c-2.888,10.196-12.258,17.67-23.379,17.67
              ...
              <path
                style={{ fill: "#FA582A" }}
                d="M119.941,101.12c-4.5-1.604-11.667,1.896-16.375,1.444c-5.145-0.494-7.93,3.002-11.094,2.368
